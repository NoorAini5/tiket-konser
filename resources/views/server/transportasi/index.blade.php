@extends('layouts.app')
@section('title', 'Jenis Konser')
@section('heading', 'Jenis Konser')
@section('styles')
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Tambah Jenis Konser</h5>
          <button
            type="button"
            class="close"
            data-dismiss="modal"
        ...
        <form action="{{ route('transportasi.store') }}" method="POST">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="kode">Kode Konser</label>
              <input
                type="text"
                class="form-control"
                id="kode"
                name="kode"
                placeholder="Kode Konser"
                required
              />
            </div>
            <div class="form-group">
