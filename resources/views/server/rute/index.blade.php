    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Tambah Detail Konser</h5>
          <button
            type="button"
            class="close"
            data-dismiss="modal"
        ...
        <form action="{{ route('rute.store') }}" method="POST">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="jam">Jam Buka Stand</label>
              <input
                type="time"
                class="form-control"
                id="jam"
