      ...
      <div class="card shadow h-100" style="border-top: .25rem solid #4e73df">
        <div class="card-body">
          <div class="row no-gutters align-items-center justify-content-center">
            <div class="col h5 font-weight-bold" style="margin-bottom: 0">Detail Pesanan</div>
            <div class="col-auto">
              <span class="title">
        ...
        <div class="card-body">
          ...
          <p style="margin-bottom: 0; margin-top: 5px;">Jadwal Konser</p>
        ...
        @if ($data->status == "Belum Check-in" && Auth::user()->level != "Penumpang")
        <div class="card-body">
